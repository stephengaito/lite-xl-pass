...
local wrappedInit = function()
  ...
  local openDoc = function(self, doc)
    if doc.filename and string.find(doc.filename, "%.gpg$") then
  ...
  -- now Monkey Patch the Doc and TreeView contextmenus
  require "pass.contextmenu"
